...
import img1 from "../../assets/images/Scholarship/img1.png";
import img2 from "../../assets/images/Scholarship/img2.png";
import yes from "../../assets/images/Scholarship/yes.png";
    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-8 md:mt-24">
        <div className="order-last md:order-first">
          <div className="ml-[-130px] -mt-8 md:mt-0">
            <SubTitle h3="JEET Training" />
          </div>
          <div>
        ...
        <div className="grid justify-center md:justify-end">
          <div className="relative ">
            <div className="w-[350px] h-[400px] p-8">
              <img className="object-cover w-full h-full hidden md:block" src={img1} alt="" />
              <div className="absolute bottom:0 left:0 md:bottom-[-80px] md:left-[-130px] w-[260px] h-[317px]">
                <img
                  src={img2}
