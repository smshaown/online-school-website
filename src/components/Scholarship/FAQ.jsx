        ...
        <div className="mx-auto mt-8 grid max-w-xl divide-y divide-neutral-200">
          <div className="py-5">
            <details className="group">
              <summary className="flex cursor-pointer list-none items-center justify-between">
                <span className="font-medium  text-lg md:text-2xl text-[#0E0E0E]">
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                To Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate libero et velit interdum, ac
              </p>
            </details>
          </div>
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                We Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate libero et velit interdum, ac
              </p>
            </details>
          </div>
